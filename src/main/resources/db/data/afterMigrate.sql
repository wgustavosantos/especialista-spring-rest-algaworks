...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo) values (3, 'Tuk Tuk Comida Indiana', 15.00, 2, utc_timestamp, utc_timestamp, true);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Macaxeira', 'Macaxeira Cozida para Café', '20.00', 1, 1);
