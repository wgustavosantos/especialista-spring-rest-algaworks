...
![Authorization Code Flow](images/authorization-flow.png)
...
![Password Grant Flow](images/client_credentials.png)
...
![Authorization Code PKCE](images/authorization-flow-pkce.png)
...
![OAuth2 Fluxo](images/oauth2-fluxo.png)
...
<img src="images/chave-assimetrica.png" width="450"/>
...
![Load Balancer](images/load-balance.png)
...
![AWS conceitos](images/aws-conceitos.png)
...
![Variáveis de ambiente no ECS](images/ecs-environment-variables.PNG)
...
![ELB](images/aws-elastic-load-balancing.png)
...
![Configuração do DNS no RegistroBr para Load Balancer DNS](images/dns-registro-br.png)
...
![Acesso via DNS no Load Balancer](images/load-balancer-acesso-via-dns.png)
...
![Fluxo básico de comunicação](images/header-protocolo-load-balancer.png)
...
![Intellij Profiles](images/intellij-profiles.png)
